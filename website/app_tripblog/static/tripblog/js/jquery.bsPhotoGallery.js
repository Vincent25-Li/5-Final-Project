(function($) {
  ...
  $.fn.bsPhotoGallery = function(options) {
      ...
      this.each(function(i){
        //ul
        var items = $(this).find('li'); // return li_list
        ...
        items.each(function(x){
          ...
          // shortText == False while initialization
          ...
          // hasModal == true while initialization
      ...
      // settings.hasModal = true while initialization
