...
--
-- Dumping data for table `app_tripblog_user`
--

LOCK TABLES `app_tripblog_user` WRITE;
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$150000$iLmwAwwNc2tU$kudeFXr/QmdArmcHDei1CWMgZ5WLlu9HheAE2m1a8DQ=','2019-09-22 05:04:43.468868',1,'admin','','','',1,1,'2019-09-22 05:02:13.933917');
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(7,'app_tripblog','user'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(6,'sessions','session');
...
-- Dump completed on 2019-09-22 15:02:29
